...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Admin logini va sessiya yaratish' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Sessiya yaratildi va cookie o\'rnatildi' }),
...
__decorate([
    (0, common_1.Get)('me'),
    (0, common_1.UseGuards)(auth_guard_1.AuthGuard),
    (0, swagger_1.ApiOperation)({ summary: 'Joriy autentifikatsiyadan o\'tgan admin ma\'lumotlarini olish' }),
